...
INSERT INTO `cigar` (`id`, `brand`, `name`, `description`, `length_ring`, `shade`, `strength`, `single_price`, `year_introduced`, `create_date`, `last_update`, `image_url`, `origin_id`, `shape_id`, `wrapper_origin_id`, `binder_origin_id`, `filler_origin_id`) VALUES (7, 'Ramon Bueso', 'Genesis Habano', 'Ramon Bueso Genesis Habano features an incredible Ecuadorian Habano ligero wrapper that gives this full-bodied blend is boldness. Combined with a delicate balance of Honduran and Nicaraguan long-fillers, this Honduran handmade exudes rich notes of wood, espresso, pepper, and nuts.', '5 x 50', 'Natural', 'Full', 9, '2012', '2025-01-27', '2025-01-27', 'https://img.thompsoncigar.com/products/RBH-PM-1020.png?v=246731&_gl=1*2gtgyi*_ga*MTA2MzgzNDczMi4xNzM3OTkxMzI3*_ga_BFZL9VYHY3*MTczNzk5MTMyNy4xLjEuMTczNzk5MTM2Ni4yMS4wLjA.', 4, 3, 15, 4, 21);
